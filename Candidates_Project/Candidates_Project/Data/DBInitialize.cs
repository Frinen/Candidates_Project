...
namespace Candidates_Project.Data
{
    public class DBInitialize
    {
        public static void Initialize(CandidatesContext context)
        {
            ...
            var candidate_l = new CandidateLanguage { CandidateID = 1, LanguageID = 1, Level = "Upper-Intermediate" };
            context.CandidateLanguages.Add(candidate_l);
            candidate_l = new CandidateLanguage { CandidateID = 1, LanguageID = 3, Level = "Elementary" };
            context.CandidateLanguages.Add(candidate_l);

            var candidate_sch = new CandidateSchool { HighSchoolID = 1, CandidateID = 1, From = DateTime.Parse("2013-09-01"), To = DateTime.Parse("2018-05-01"), Degree = "Master" };
            context.CandidateSchools.Add(candidate_sch);

            var candidate_sk = new CandidateSkill { CandidateID = 1, SkillID = 1, Level = "Master", Month = 24 };
            context.CandidateSkills.Add(candidate_sk);
            */
            context.SaveChanges();
        }
    }
